...
function addActionsforHTMLUI() {
  ...
  document.getElementById("circle_Point").onclick = function () {
    choose_shape = 2;
  };
...
function drawPicture() {
  ...
  fishbody1 = new Point([1, 0.69, 0, 1], 72, [-0.5999884271621704, -0.3]);
  fishbody2 = new Point([1, 0.69, 0, 1], 72, [-0.2999884271621704, -0.3]);
  fishbody3 = new Point([1, 0.69, 0, 1], 72, [0.0519884271621704, -0.3]);
  big_bubble = new Circle(
    [0, 1, 0.95, 1],
    101,
    [0.7850115728378296, 0.6749884271621704],
    24
  );
  small_bubble = new Circle(
    [0, 1, 0.95, 1],
    60,
    [0.5850115728378296, 0.2749884271621704],
    24
  );
  fish_head = new Circle([1, 0.69, 0, 1], 75, [0.2550115728378296, -0.3], 7);
  fish_eye_outer = new Point(
    [1, 1, 1, 1],
    25,
    [0.1600115728378296, -0.3050115728378296]
  );
  fish_eye_inner = new Point(
    [0, 0, 0, 1],
    15,
    [0.1800115728378296, -0.27501157283782957]
  );
  fin_1 = new Triangle(
    [1, 1, 0.24, 1],
    50,
    [-0.3399884271621704, -0.12334490716457366]
  );
  fin_2 = new Triangle(
    [1, 1, 0.24, 1],
    50,
    [-0.3399884271621704, -0.47334490716457366],
    [],
    "right_down"
  );
  smile = new Triangle(
    [1, 1, 0.24, 1],
    15,
    [0.3200115728378296, -0.3550115728378296],
    [],
    "right_down"
  );
